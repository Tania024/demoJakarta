...
a persistence unit "demoJakartaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demoJakarta/pom.xml":
...
artifact ("demoJakarta.war") is already built. You can build
